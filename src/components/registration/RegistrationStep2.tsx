        ...
        <form className="space-y-6" onSubmit={onNext}>
            <div className="space-y-5">
                ...
                {(formData.role !== 'Customer') && (
                    <div className="bg-green-50 rounded-2xl p-5 border border-green-100">
                        <h3 className="text-sm font-bold text-green-700 mb-3">Business Location</h3>
                        ...
                        {isLocationSet && !isMapOpen ? (
                            ...
                            isMapOpen ? (
                                // GeoPicker is Open
                                <div className="p-4 border border-green-200 rounded-xl bg-white shadow-inner">
                                    <div className="flex justify-between items-center mb-3">
                                        ...
                                        <button
                                            ...
                                            className="p-1 text-slate-500 hover:text-green-600 hover:bg-green-50 rounded-full transition-colors"
                                        >
                                            <X size={18} />
                                        </button>
                                    </div>
                                ...
                                <button
                                    onClick={() => setIsMapOpen(true)}
                                    type="button"
                                    className="w-full py-4 border-2 border-dashed border-green-200 rounded-2xl text-green-500 hover:bg-green-100/50 transition-colors flex flex-col items-center justify-center gap-1"
                                >
                                    <MapPin size={24} />
            ...
            <div className="flex gap-3 pt-2">
                ...
                <button
                    ...
                    className="flex-[2] flex justify-center items-center py-3 px-4 border border-transparent rounded-2xl shadow-lg shadow-green-200 text-sm font-bold text-white bg-green-600 hover:bg-green-700 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
