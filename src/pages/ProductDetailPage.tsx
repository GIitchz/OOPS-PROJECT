        ...
        <div className="flex flex-wrap items-center gap-2 mb-6">
            ...
            {categories.map((category) => (
                <span
                    ...
                    className="inline-block px-3 py-1 text-sm font-semibold text-green-800 bg-green-100 rounded-full border border-green-300"
                >
...
const SellerList: React.FC<SellerListProps> = ({ listings, selectedListing, setSelectedListing, targetRole, currentSort, setSort }) => {
    ...
    return (
        <div className="bg-white rounded-xl p-6 mb-8 border border-green-200 shadow-inner">
            <div className="flex justify-between items-center mb-4">
                <label className="flex items-center gap-2 text-base font-bold text-green-800">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-600">
                    ...
                    <select
                        id="listing-sort"
                        className="p-1.5 border border-slate-300 rounded-lg bg-white focus:ring-green-500 focus:border-green-500 text-sm font-medium transition-shadow"
                        value={currentSort}
                    ...
                    return (
                        <div
                            ...
                            className={`
                                ...
                                ${isSelected
                                    ...
                                    : 'border-slate-200 bg-gray-50 hover:bg-gray-100 hover:border-green-300'
                                }
                        ...
                        >
                            ...
                            <div className="text-right flex-shrink-0">
                                <p className="text-xl font-extrabold text-green-600 mb-0.5">
                                    ₹{l.price.toFixed(2)}
                                </p>
...
function ProductDetailPage() {
    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 text-green-500 font-extrabold text-lg">
    ...
    if (!product || product.listings.length === 0) return (
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center bg-gray-50 p-8 text-center">
            ...
            <button onClick={() => navigate(-1)} className="text-green-600 font-bold hover:underline flex items-center gap-1">
    ...
    return (
        <div className="min-h-[calc(100vh-80px)] bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="flex items-center gap-2 text-slate-600 hover:text-green-700 font-medium mb-8 transition-colors group"
                >
                ...
                <div className="bg-white rounded-3xl shadow-2xl shadow-green-100 overflow-hidden border border-slate-100">
                        ...
                        <div className="p-8 lg:p-16 flex flex-col">
                            ...
                            <div className="border-t border-slate-100 pt-8 mt-4">
                                ...
                                <div className="flex gap-4">
                                    <button
                                        className="flex-1 flex items-center justify-center gap-2 bg-green-600 border border-transparent rounded-2xl py-4 px-8 text-xl font-extrabold text-white hover:bg-green-700 hover:shadow-xl hover:shadow-green-200 focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-green-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-[1.01]"
                                        disabled={!isInStock}
                ...
                <div className="max-w-5xl mx-auto mt-16">
                    <h2 className="text-3xl font-bold text-slate-900 mb-8 pb-3 border-b-4 border-green-100">
                                        ...
                                        {reviews.map((review, index) => (
                                            <div key={index} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-slate-100">
                                                ...
                                                <div className="flex items-center text-sm font-semibold text-slate-600 border-t border-slate-50 pt-3 mt-3">
                                                    ...
                                                    <span className="ml-2 px-2 py-0.5 bg-green-50 text-green-600 rounded-full text-xs font-bold uppercase tracking-wider">
                                                        {review.buyer.role}
                                                    </span>
                                                </div>
                                            </div>
